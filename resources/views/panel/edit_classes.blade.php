...
<div class="container-fluid pt-25">
				...
				<div class="row">
					...
					<form data-toggle="validator" role="form" class="form-horizontal"  method="POST" action="{{ route('classes.update', ['id' => $classes->id]) }}" enctype="multipart/form-data">
						{{ method_field('PUT') }}
						<input name="_token" type="hidden" value="{{ csrf_token() }}"/>
					<div class="form-group">
						<div class="col-md-6">
							<label class="control-label mb-10">العنوان <span class="help text-danger"> *</span></label>
							<input type="text" class="form-control" placeholder="العنوان " required name="name" value="{{ $classes->name }}">
						</div>
					</div>
