...
<div class="row heading-bg">
							<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
								<h5 class="txt-dark">اضافة مشرف</h5>
							</div>
							...
							<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
								<ol class="breadcrumb">
									...
									<li class="active"><a href="#"><span>اضافة مشرف </span></a></li>
								</ol>
							</div>
							<!-- /Breadcrumb -->
				...
				<div class="row">
					...
					<form data-toggle="validator" role="form" class="form-horizontal"method="POST" action="{{ action('SupervisorController@store') }}" enctype="multipart/form-data">
					...
					<div class="form-group">
							<div class="col-md-6">
								...
								<input type="date" class="form-control" data-mask="99/99/9999" placeholder=""  value="{{ old('born_date') }}" name="born_date">
					...
					<div class="form-group">
							<div class="col-md-6">
								...
								<input type="text" class="form-control" placeholder="" value="{{ old('section') }}" name="section">
							</div>
					</div>
