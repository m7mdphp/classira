...
<div class="row heading-bg">
							<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
								<h5 class="txt-dark">أضافة ولي أمر</h5>
							</div>
							...
							<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
								<ol class="breadcrumb">
									...
									<li class="active"><a href="#"><span>أضافة ولي أمر</span></a></li>
								</ol>
							</div>
							<!-- /Breadcrumb -->
				<div class="row">
				...
				<div class="row">
					...
					<form data-toggle="validator" role="form" class="form-horizontal" method="POST" action="{{ action('GuardianController@store') }}" enctype="multipart/form-data">
