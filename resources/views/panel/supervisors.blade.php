					...
					<div class="row heading-bg">
							...
							<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
								<ol class="breadcrumb">
									...
									<li class="active"><a href="#"><span>المشرفين</span></a></li>
								</ol>
							</div>
							<!-- /Breadcrumb -->
						<div class="row">
					<div class="col-md-12 mt-15 mb-20">
							<a href="{{url('supervisors/create')}}" class="btn btn-primary">اضافة مشرف</a>
					</div>
						...
						<div class="col-md-12 mt-40 mb-20">
							<div class="btn-group">
								...
								<a href="{{url('supervisors')}}" class="btn btn-primary active">المشرفين</a>
									...
									<table id="supervisors" class="table table-hover display  pb-30" >
										...
										<tbody>
											...
											<tr>
												...
												<td><a href="{{ URL::to('/supervisors/' . $supervisors->id . '/edit') }}" class="btn btn-success" style="float: right; margin-left: 5px;"><i class="zmdi zmdi-edit"></i></a>
													<form method="POST" action="{{ URL::to('/supervisors/' . $supervisors->id) }}">
        											{{ csrf_field() }}
        											{{ method_field('DELETE') }}
...
@endsection
@section('js')
<script src="{{ asset('dist/js/supervisors.js') }}"></script>
@endsection