...
<div class="row heading-bg">
							<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
								<h5 class="txt-dark">أضافة معلم</h5>
							</div>
							...
							<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
								<ol class="breadcrumb">
									...
									<li class="active"><a href="#"><span>أضافة معلم</span></a></li>
								</ol>
							</div>
							<!-- /Breadcrumb -->
				<div class="row">
				...
				<div class="row">
					...
					<form data-toggle="validator" role="form" class="form-horizontal" method="POST" action="{{ action('TeacherController@store') }}" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="form-group">
							<div class="col-md-6">
								...
								<input type="text" class="form-control" placeholder="الرقم الوظيفي" required name="job_num" value="{{ old('job_num') }}">
							</div>
					</div>
					...
					<div class="checkbox checkbox-primary">
						...
						<div class="form-group">
							<div class="col-md-6">
								...
								<input type="text" class="form-control" placeholder="التخصص" name="section" value="{{ old('section') }}">
							</div>
					</div>
