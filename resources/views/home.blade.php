                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default card-view">
                            <div class="panel-heading">
                                <div class="pull-left">
                                    <h6 class="panel-title txt-dark">جديد الاخبار</h6>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body">
                                    <!-- START carousel-->
                                    <div id="carousel-example-captions-1" data-ride="carousel" class="carousel slide" style="height:200px;overflow:hidden;">

                                        <div role="listbox" class="carousel-inner">
                                            <div class="item active text-center">
                                                <img src="{{ asset('dist/img/big/img4.jpg') }}" alt="First slide image">
                                            </div>
                                            ...
                                            <div class="item text-center">
                                                <img src="{{ asset('dist/img/big/img6.jpg') }}" alt="Third slide image">
                                            </div>
                                        </div>
